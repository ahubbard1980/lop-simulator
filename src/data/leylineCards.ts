...
export const LEYLINE_CARDS: CardTemplate[] = [
  ...
  { name: 'Leyline of Convergence', type: 'Leyline', affinity: 'Prismatic', rarity: 'Uncommon', set: SET, entersReady: false, rulesText: 'This enters exhausted.\nExhaust this: Channel 1.\nExhaust this: Focus 1. Lose 1 life. (You may do this as any affinity.)', imageUrl: img('Leyline of Convergence (Prismatic)') },
  ...
  { name: 'Leyline of Entropic Surge', type: 'Leyline', affinity: 'Chaos', rarity: 'Uncommon', set: SET, entersReady: false, rulesText: 'This enters exhausted.\nExhaust this: Channel 1.\nExhaust this: Focus 1. Do this if you rolled a dice this turn.', imageUrl: img('Leyline of Entropic Surge') },
  { name: 'Leyline of Dawnsong', type: 'Leyline', affinity: 'Divinity', rarity: 'Uncommon', set: SET, entersReady: false, rulesText: 'This enters the field exhausted.\nExhaust this: Channel 1.\nConsecrate 3 - Ready this Leyline.', imageUrl: img('Leyline of Dawnsong') },
  { name: 'Leyline of Benediction', type: 'Leyline', affinity: 'Divinity', rarity: 'Uncommon', set: SET, entersReady: false, rulesText: 'This enters the field exhausted.\nExhaust this: Channel 1.\nExhaust this: Gain 1 Focus. Do this only if you have gained life this turn.', imageUrl: img('Leyline of Benediction') },
  { name: 'Leyline of Hunger', type: 'Leyline', affinity: 'Corruption', rarity: 'Uncommon', set: SET, entersReady: false, rulesText: 'This enters the field exhausted.\nExhaust this: Channel 1.\nExhaust this, Focus 3: Choose an Enemy, they lose 1 life and you gain 1 life. Activate this only as a Ritual.', imageUrl: img('Leyline of Hunger') },
  { name: 'Leyline of Malevolence', type: 'Leyline', affinity: 'Corruption', rarity: 'Uncommon', set: SET, entersReady: false, rulesText: 'This enters the field exhausted.\nExhaust this: Channel 1.\nExhaust this: Gain 1 Focus. Do this only if you have Siphoned this turn.', imageUrl: img('Leyline of Malevolence') },
  { name: 'Leyline of Bloom', type: 'Leyline', affinity: 'Primal', rarity: 'Uncommon', set: SET, entersReady: false, rulesText: 'This enters the field exhausted.\nExhaust this: Channel 1.\nWhen this enters the field, conjure a 0/1 Primal Plant.', imageUrl: img('Leyline of Bloom') },
  { name: 'Leyline of Convergence', type: 'Leyline', affinity: 'Primal', rarity: 'Uncommon', set: SET, entersReady: false, rulesText: 'This enters the field exhausted.\nExhaust this: Channel 1.\nExhaust this: Gain 1 Focus. Do this if you have Summoned a Creature this turn.', imageUrl: img('Leyline of Convergence (Primal)') },
  { name: 'Leyline of Knowledge', type: 'Leyline', affinity: 'Arcane', rarity: 'Uncommon', set: SET, entersReady: false, rulesText: 'This enters the field exhausted.\nExhaust this: Channel 1.\nExhaust this, Focus 1: Learn 1.', imageUrl: img('Leyline of Knowledge') },
  { name: 'Leyline of Wisdom', type: 'Leyline', affinity: 'Arcane', rarity: 'Uncommon', set: SET, entersReady: false, rulesText: 'This enters the field exhausted.\nExhaust this: Channel 1.\nExhaust this: Gain 1 Focus. Do this if you have Learned this turn.', imageUrl: img('Leyline of Wisdom') },
];
