// Small, clean line icons for the button bar — kept as plain inline SVG so
// there's no icon-font/asset dependency.
...
// "This card transforms" indicator — a double-arrow loop, same visual
// language as the transform icon printed on real dual-faced cards.
export function TransformIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M17 2.1l4 4-4 4" />
      <path d="M3 12.9V10a4 4 0 0 1 4-4h14" />
      <path d="M7 21.9l-4-4 4-4" />
      <path d="M21 11.1V14a4 4 0 0 1-4 4H3" />
    </svg>
  );
}
