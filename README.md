...
- `src/net/` — Supabase client, auth store, cloud deck sync, the Online multiplayer relay (rooms, room actions, matchmaking handshake), and the Card Editor's own data layer (drafts, frames, rarity emblems, secondary types, inline text icons, text layout overrides, storage asset uploads)
